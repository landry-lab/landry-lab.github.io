...
```{=html}
  ...
  <svg viewBox="0 0 800 300" preserveAspectRatio="xMinYMin meet" width="100%"></svg>
  <div id="tooltip" style="position: absolute; opacity: 0; background: white; border: 1px solid #ccc; padding: 6px 10px; border-radius: 4px; font-size: 13px; pointer-events: none;"></div>
  <script>
    ...
    const margin = {top: 25, right: 0, bottom: 0, left: 125};
