...
## Pairwise and higher-order networks
...
## The spread of diseases and ideology
...
* [Hypergraph assortativity: a dynamical systems perspective](https://doi.org/10.1063/5.0086905)
...
We use a Bayesian framwork to reconstruct networks from all kinds of data: mobility, time-series, contact tracing, and survey data.

References:

* [Complex contagions can outperform simple contagions for network reconstruction with dense networks or saturated dynamics](https://doi.org/10.48550/arXiv.2405.00129)
